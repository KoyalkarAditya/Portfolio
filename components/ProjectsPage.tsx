...
export function ProjectsPage() {
  return (
    <div className=" px-72  pt-28 flex flex-col justify-center dark:text-black">
      <div className=" font-bold text-3xl font-mono text-center dark:text-white">
        Projects
      </div>
...
const ProjectOne = ({
  ...
  return (
    <div className=" p-8 w-full flex items-center justify-between  rounded-3xl border-2 border-dark  border-solid  bg-light shadow-2xl">
      <Link
        href={link}
        target={"_blank"}
      ...
      <div className=" w-1/2 flex flex-col items-start justify-between pl-6">
        ...
        <span className=" text-slate-500 font-medium text-xl">{type}</span>
        <p className=" font-mono my-2 font-medium  ">{summary}</p>
...
const ProjectTwo = ({
  ...
  return (
    <div className=" p-8 w-full flex items-center justify-between relative  rounded-3xl border-2 border-dark  border-solid  bg-light shadow-2xl">
      <Link
        href={link}
        target={"_blank"}
        className="w-1/2 cursor-pointer overflow-hidden rounded-lg"
...
function Button({ text }: { text: string }) {
  return (
    <button
      type="button"
      className="text-green-700  border border-green-700  focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-xs px-3 py-2 text-center me-2 mb-2 dark:border-green-500 dark:text-green-500  dark:focus:ring-green-800"
    >
      {text}
    </button>
  );
